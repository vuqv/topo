...
rate). TOPO ships a small library of them.
...
Keep the thermostat consistent with the table's temperature: `ref_t` defaults to
**310 K** to match the *E. coli* table — set it to your table's temperature if it

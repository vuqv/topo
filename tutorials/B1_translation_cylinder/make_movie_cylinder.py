"""Stitch the topo B.1 cylinder elongation into a VMD movie + draw the tunnel.
...
def _write_tcl_cylinder(path: str, psf_name: str, dcd_name: str, park: str,
    ...
    tcl = f"""# VMD visualization of the topo B.1 cylinder elongation + the analytic exit tunnel.
...
def main(argv: Optional[list] = None) -> None:
    ...
    ap = argparse.ArgumentParser(
        ...
        description="Stitch the topo B.1 per-length elongation trajectories "

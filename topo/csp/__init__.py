...
topo style. It is the kinetic upgrade of :mod:`topo.translation.elongate`: it times
...
See :mod:`topo.csp.csp` (runner + INI) and :mod:`topo.csp.kinetics` (timing core).
"""
from topo.csp.csp import (CSPConfig, CSPParams, csp, read_csp_config,

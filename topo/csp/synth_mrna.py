...
def write_synthetic_mrna(pdb_path: str, codon_time_table_path: str, mode: str,
    ...
    header = [
        ...
        f"# generated by topo.csp.synth_mrna (mrna={mode}); one codon per residue",
    ]
...
def main(argv=None) -> None:
    """``topo-make-mrna`` CLI: write a fastest/slowest/median mRNA for a protein + table."""
    ap = argparse.ArgumentParser(
        prog="topo-make-mrna",
        description="Write a fastest/slowest/median synonymous-codon mRNA for a protein "
                    "(preparation step for the topo.csp synthesis workflow).",

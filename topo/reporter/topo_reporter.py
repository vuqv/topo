...
from topo.core import system


class topoReporter(StateDataReporter):
    """
    A special case of the StateDataReporter class that outputs information about a simulation,
    such as energy and temperature, etc. to a file. This special reporter outputs the TOPO
    force group energies inside the topo system object.

    It is used in the same way as the OpenMM StateDataReporter class, but it takes as additional
    input an instance of the topo system object with the option 'sbmObject'.
    ...
    def __init__(self, file, reportInterval, sbmObject=None, **kwargs):
        ...
        sbmObject : topo.core.system
            The TOPO system instance to read force groups from.
        **kwargs : openMM StateDataReporter arguments
        ...
        """
        super(topoReporter, self).__init__(file, reportInterval, **kwargs)
    ...
    def _constructHeaders(self):
        ...
        for the force groups contained in the topo system instance.
    ...
    def _constructReportValues(self, simulation, state):
        """
        Calculates the energies for the force groups in the TOPO system instance.
